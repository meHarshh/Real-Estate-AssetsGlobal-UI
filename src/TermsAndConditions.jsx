    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <p>
                    Welcome to <span className="highlight" style={{ color: '#7ab945' }}>Assets Global</span>!
                </p>
                <p>
                    These terms and conditions outline the rules and regulations for the use
                    of Assets Global's Website, located at{" "}
                    <a href="https://assetsglobal.in/">https://assetsglobal.in/</a>.
                </p>
                <p>
                    By accessing this website we assume you accept these terms and conditions.
                    Do not continue to use Assets Global if you do not agree to take all of
                ...
                <p>
                    ...
                    law of af. Any use of the above terminology or other words in the
                    singular, plural, capitalization and/or he/she or they, are taken as
                    interchangeable and therefore as referring to same.
                </p>
                <h3>
                    <strong style={{color:'#7ab945'}}>Cookies</strong>
                </h3>
                <p>
                    We employ the use of cookies. By accessing Assets Global, you agreed to
                    use cookies in agreement with the Assets Global's Privacy Policy.
                </p>
                <p>
                ...
                <h3>
                    <strong style={{ color: '#7ab945' }}>License</strong>
                </h3>
                <p>
                    Unless otherwise stated, Assets Global and/or its licensors own the
                    intellectual property rights for all material on Assets Global. All
                    intellectual property rights are reserved. You may access this from Assets
                    Global for your own personal use subjected to restrictions set in these
                    terms and conditions.
                </p>
                <p>You must not:</p>
                <ul>
                    <li>Republish material from Assets Global</li>
                    <li>Sell, rent or sub-license material from Assets Global</li>
                    <li>Reproduce, duplicate or copy material from Assets Global</li>
                    <li>Redistribute content from Assets Global</li>
                </ul>
                <p>
                    Parts of this website offer an opportunity for users to post and exchange
                    opinions and information in certain areas of the website. Assets Global
                    does not filter, edit, publish or review Comments prior to their presence
                    on the website. Comments do not reflect the views and opinions of Assets
                    Global, its agents and/or affiliates. Comments reflect the views and
                    opinions of the person who post their views and opinions. To the extent
                    permitted by applicable laws, Assets Global shall not be liable for the
                ...
                <p>
                    Assets Global reserves the right to monitor all Comments and to remove any
                ...
                <p>
                    You hereby grant Assets Global a non-exclusive license to use, reproduce,
                    edit and authorize others to use, reproduce and edit any of your Comments
                    in any and all forms, formats or media.
                </p>
                <h3>
                    <strong style={{ color: '#7ab945' }}>Hyperlinking to our Content</strong>
                </h3>
                <p>
                ...
                <p>
                    ...
                    hyperlink compensates the absence of Assets Global; and (d) the link is in
                ...
                <p>
                    ...
                    e-mail to Assets Global. Please include your name, your organization name,
                ...
                <p>
                    No use of Assets Global's logo or other artwork will be allowed for
                    linking absent a trademark license agreement.
                </p>
                <h3>
                    <strong style={{ color: '#7ab945' }}>iFrames</strong>
                </h3>
                <p>
                ...
                <h3>
                    <strong style={{ color: '#7ab945' }}>Content Liability</strong>
                </h3>
                <p>
                ...
                <h3>
                    <strong style={{ color: '#7ab945' }}>Reservation of Rights</strong>
                </h3>
                <p>
                ...
                <h3>
                    <strong style={{ color: '#7ab945' }}>Removal of links from our website</strong>
                </h3>
                <p>
                ...
                <h3>
                    <strong style={{ color: '#7ab945' }}>Disclaimer</strong>
                </h3>
                <p>
